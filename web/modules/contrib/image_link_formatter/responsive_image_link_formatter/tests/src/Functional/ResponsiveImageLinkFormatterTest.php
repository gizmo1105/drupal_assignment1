...
class ResponsiveImageLinkFormatterTest extends ResponsiveImageFieldDisplayTest {
  ...
  public function testResponsiveImageLinkFormatterWrappedImage() {
    ...
    // As of 10.1, lazy loading is part of core image formatter's
    // configuration but the position of the attribute changed.
    $expected_result = [
      'link' => '<a href="http://example.com"><img alt="" loading="lazy" src="@file_url" width="40" height="20" /></a>',
      'no_link' => '<img alt="" loading="lazy" src="@file_url" width="40" height="20" />',
    ];
