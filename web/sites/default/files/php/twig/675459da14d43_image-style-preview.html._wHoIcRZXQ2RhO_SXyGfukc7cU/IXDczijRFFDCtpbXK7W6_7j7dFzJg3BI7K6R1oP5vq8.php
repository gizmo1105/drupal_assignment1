...
class __TwigTemplate_58d2604e224f9badf0535f50eefcab82 extends Template
{
  ...
  ";
      ...
      ";
        ...
        yield " (<a href=\"";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["original"] ?? null), "url", [], "any", false, false, true, 36), "html", null, true);
        yield "\">";
  ...
  ";
    ...
    ";
        // line 48
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["style_name"] ?? null), "html", null, true);
        yield " (<a href=\"";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["derivative"] ?? null), "url", [], "any", false, false, true, 48), "html", null, true);
        yield "?";
